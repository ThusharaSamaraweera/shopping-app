...
const ChangeShippingForm: React.FC = () => {
  ...
  const handleOnPostalCodeChanged = (postalCode: string) => {
    disptach(changeCheckoutShippingForm({key: "postalCode", value: postalCode}))
  }
  ...
  const handleOnContactNumberChanged = (contactNumber: string) => {
    disptach(changeCheckoutShippingForm({key: "contactNumber", value: contactNumber}))
  }
      ...
      <Form>
        ...
        <Form.Row className="city-postal-country-input">
          <Form.Group as={Col} xs={12} sm={12} md={4} controlId="billingAddressCity" className="city-input">
            ...
            <Row>
              <span className='error-message'>
                {changedShippingFormError.cityError && changedShippingFormError.cityError}
              </span>
            </Row>
          </Form.Group>
          ...
          <Form.Group as={Col} xs={12} sm={12} md={4} controlId="formGridPostalCode" className="postal-code-input">
            ...
            <Row>
              <span className='error-message'>
                {changedShippingFormError.postalCodeError && changedShippingFormError.postalCodeError}
              </span>
            </Row>
          </Form.Group>
          ...
          <Form.Group controlId="billingAddressContactNumber">
            ...
            <InputGroup className="mb-1">
              ...
              <FormControl
                ...
                type="tel"
                pattern="^\d{10}$"
                value={changedShippingForm.contactNumber
